        ...
        <div class="right_col" role="main">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <form:form id="query-form" modelAttribute="street" class="form-horizontal form-label-left">
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">街道名称
                            </label>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                    <table id="street-table" class="table table-striped table-bordered bulk_action"
