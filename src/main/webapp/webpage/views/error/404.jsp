...
<div class="container-fluid housekeeping-layout">
    <div class="row">
        <div class="column col-xs-12 col-sm-12 col-md-12 col-lg-12 content-center">
            <div class="jumbotron content-center">
                <h1>介个是404错误界面</h1>
                <p>请求资源路径错误</p>
                <p><a class="btn btn-primary btn-lg" href="/housekeeping/loginPage" role="button" id="pre-page">去认证</a></p>
            </div>
        </div>
    </div>
</div>
